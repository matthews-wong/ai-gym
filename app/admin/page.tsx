        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              disabled={refreshing}
              className="flex items-center gap-2 px-4 py-2 bg-stone-800 hover:bg-stone-700 disabled:opacity-50 text-white rounded-xl transition-colors"
            >
                  ...
                  >
                        ...
                        {editingUserId === u.id ? (
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              className="px-2 py-1 text-sm bg-stone-700 border border-stone-600 rounded text-white w-32"
                          ...
                          <div className="flex items-center gap-2">
                            <p className={`text-sm font-medium ${u.username ? "text-white" : "text-stone-500 italic"}`}>
                              {u.username || "No username"}
                            </p>
                            <button
                              onClick={() => handleEditUsername(u)}
                              className="p-1 text-stone-500 hover:text-blue-400 hover:bg-blue-500/10 rounded opacity-0 group-hover:opacity-100 transition-opacity"
                            >
                    ...
                    <div className="flex items-center gap-2">
                      {editingUserId !== u.id && (
                        <button
                          onClick={() => handleEditUsername(u)}
                          className="p-1.5 text-stone-500 hover:text-blue-400 hover:bg-blue-500/10 rounded-lg transition-colors"
                          title="Edit username"
                        >

  ...
  return (
    <div className="min-h-screen bg-stone-950 pt-20">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-teal-500/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-500/10 border border-teal-500/20 mb-6">
            ...
            <span className="text-sm text-teal-300 font-medium">AI Personal Trainer</span>
          </div>
          ...
          <p className="text-stone-400 max-w-md mx-auto">
            Tell us about your goals and we&apos;ll create a personalized plan for you.
          </p>
        </div>
